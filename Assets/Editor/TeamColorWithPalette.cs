...
[System.Serializable]
public class TeamColorWithPalette
{
    ...
    public Color32[] GetTeamColorPalette(int teamId)
    {
        Color32[] teamColor = new Color32[mTeamColorVariationsCount];
...
//		texture.wrapMode = TextureWrapMode.Clamp;
		...
		for (int y = 0; y < texture.height; y++)
		{
			...
			for (int x = 0; x < texture.width; x++)
			{
				...
				{
					Color32 refColor;
					for (int iColorVariation = 0; iColorVariation < mColorIntensityCount; iColorVariation++)
					{
						refColor = TeamColor.referenceColors[iColor, iColorVariation];
...
//							newColor = TeamColor.referenceColors[fColorId,iColorIntensity];
	...
	public static Color32 redDark = new Color32(128, 0, 0, 255);
	public static Color32 redMiddel = new Color32(192,0,0,255);
	public static Color32 redLight = new Color32(255, 0, 0, 255);
	public static Color32 redLight32 = new Color32((byte)255, (byte)0, (byte)0, (byte)255);
